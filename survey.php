...
$SHOPID = $_GET['edit'];
$edit_state= true;
$rec= mysqli_query($db, "SELECT * FROM survey WHERE SHOPID='$SHOPID'");
$record = mysqli_fetch_array($rec);
$SHOPID= $record['SHOPID'];
$SHOPNAME= $record['SHOPNAME'];
$CUSTNAME = $record['CUSTNAME'];
$SHOPDESCR = $record['SHOPDESCR'];
$DATE= $record['DATE'];
$TIME= $record['TIME'];
...
<div class="nav">
  ...
  <a href='infoCUST.php'><b>Customer</b></a>

  <a href='infoSALES.php'><b>SalesPerson</b></a></a>


  <a href='infoPRO.php'><b>Product</b></a>

  <a class="active" href='index.php'><b>Invoice</b></a>
...
<input type= "text" name="SHOPDESCR" value="<?php echo $SHOPDESCR;?>" >
</div>
<div class="input-group">
<label>DATE</label>
